...
@section('content')
    ...
    <section class="content">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{ route('program.store') }}" method="POST" id="form" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="ckeditor form-control" rows="10" placeholder="Deskripsi singkat program" name="description"></textarea>
                                @error('description')
                                    <small class="text-danger" role="alert">{{ $message }}</small>
                                @enderror
                            </div>
